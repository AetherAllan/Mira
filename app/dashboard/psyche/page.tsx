import { Brain, CirclePause, Footprints, Scale, Sparkles } from "lucide-react";
...
export default async function PsychePage() {
  ...
  return (
    <>
      <PageIntro title="Id / Ego / Superego" description="驱动提出愿望，Ego 选择行动，Critic 做边界与风格审查。任何一层都不能单独直接发 Telegram。" />
